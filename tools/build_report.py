...
add_heading("5.3 Prueba de usabilidad que falta realizar", level=2)
...
add_para(doc, "El proyecto ya cuenta con un sistema funcional y evidencia técnica reproducible. Para cerrar la entrega, nos falta probarlo con estudiantes, anotar sus comentarios reales, colocar los nombres del equipo si el docente los pide y presentar el flujo completo.")
